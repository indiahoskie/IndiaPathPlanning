...
class GridGraph:
    ...
    def __init__(self, file_path=None, width=-1, height=-1, origin=(0, 0),
        ...
        self.parent_dict = {}  # Dictionary to store parent relationships
    ...
    def check_collision(self, i, j):
        ...
        # use the previously calculated mask over the robot radius to
        ...
        # indices in the bounds of the grid after shifting the
        # robot mask to the cell 
    ...
    def get_parent(self, cell):
        ...
        if not hasattr(self, 'parent_dict'):
            return None
        
        cell_tuple = (cell.i, cell.j)
        if cell_tuple not in self.parent_dict:
            return None
        
        parent_cell = self.parent_dict[cell_tuple]
        return parent_cell
    ...
    def init_graph(self):
        ...
        self.parent_dict = {}  # Reset parent dictionary
